...
export default function LeftDock() {
  ...
  useEffect(() => {
    ...
    const handleShowDrawer = (event: CustomEvent<{ panelType: string; pagesElement?: HTMLElement; layersElement?: HTMLElement; panelElement?: HTMLElement }>) => {
        ...
        {dockItems.map((item) => {
          ...
          return (
            <button
              ...
              onClick={isCmdRouted ? undefined : () => handleItemClick(item)}
