...
export default function CanvasHost({ className }: CanvasHostProps) {
  ...
  useEffect(() => {
    ...
    const mountManagers = () => {
      ...
      try {
        ...
        if (el) {
          ...
          // @ts-expect-error: grapesjs LayerManager lacks types
          if (view && view.el) el.appendChild(view.el as HTMLElement);
      ...
      try {
        ...
        if (el) {
          ...
          // @ts-expect-error: grapesjs AssetManager lacks types
          if (view && view.el) el.appendChild(view.el as HTMLElement);
      ...
      try {
        ...
        if (el) {
          ...
          // @ts-expect-error: grapesjs StyleManager lacks types
          if (view && view.el) el.appendChild(view.el as HTMLElement);
    ...
    return () => {
      ...
      // @ts-expect-error: cleanup global editor reference
